...
var _prikhi$elm_http_builder$HttpBuilder$attempt = F4(
	function (msg, successReader, errorReader, builder) {
		return A2(
			_elm_lang$core$Task$attempt,
			msg,
			A3(_prikhi$elm_http_builder$HttpBuilder$send, successReader, errorReader, builder));
	});

var _user$project$Main$jsonify = function (str) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'{\"sentiment\":\"',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(model.classification),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {sentiment: a, classification: b};
	});
...
var _user$project$Main$JSONResponse = F2(
	function (a, b) {
		return {classification: a, status: b};
	});
var _user$project$Main$decodeJson = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Main$JSONResponse,
	A2(_elm_lang$core$Json_Decode$field, 'classification', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'status', _elm_lang$core$Json_Decode$int));
var _user$project$Main$fetchSentiment = F2(
	function (str, msg) {
		return A2(
			...
			A3(
				...
				A2(
					...
					'application/json',
					_user$project$Main$jsonify(str)),
				_user$project$Main$decodeJson));
	});
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		if (_p1.ctor === 'Submit') {
			...
			return {
				ctor: '_Tuple2',
				_0: A2(_user$project$Main$Model, _p2, model.classification),
				_1: A2(_user$project$Main$fetchSentiment, _p2, _user$project$Main$Fetch)
			};
		} else {
			if (_p1._0.ctor === 'Ok') {
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$Main$Model, '', _p1._0._0.classification),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
...
var _user$project$Main$inputArea = A2(
	_elm_lang$html$Html$textarea,
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$Submit),
			_1: {ctor: '[]'}
		}
	},
	{ctor: '[]'});
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Trier Sentiments'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _user$project$Main$inputArea,
						_1: {
							ctor: '::',
							_0: A2(
							...
							_1: {
								ctor: '::',
								_0: _user$project$Main$viewResult(model),
								_1: {ctor: '[]'}
							}
						}
					}
